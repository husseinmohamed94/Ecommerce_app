...
<div class="row">
    <div class="col-md-3 text-center">
        <img src="{{asset('cart/images/img_1.png')}}" width="150px" height="150px">
        <br>
    ...
    <div class="col-md-3 text-center">
        <img src="{{asset('cart/images/img_2.png')}}" width="150px" height="150px">
        <br>
    ...
    <div class="col-md-3 text-center">
        <img src="{{asset('cart/images/img_3.png')}}" width="150px" height="150px">
        <br>
    ...
    <div class="col-md-3 text-center">
        <img src="{{asset('cart/images/img_4.png')}}" width="150px" height="150px">
        <br>
    ...
    <div class="col-md-3 text-center">
        <img src="{{asset('cart/images/img_5.png')}}" width="150px" height="150px">
        <br>
...
<script src="{{asset('cart/js/jquery-2.2.3.min.js')}}"></script>
<script type='text/javascript' src="{{asset('cart/js/bootstrap.min.js')}}"></script>
<script type='text/javascript' src="{{asset('cart/js/jquery.mycart.js')}}"></script>
<script type="text/javascript">
    $(function () {
        ...
        $('.my-cart-btn').myCart({
            ...
            numberOfDecimals: 2,
            cartItems: [
                {id: 1, name: 'product 1', summary: 'summary 1', price: 10, quantity: 1, image: '{{asset('cart/images/img_1.png')}}'},
                {id: 2, name: 'product 2', summary: 'summary 2', price: 20, quantity: 2, image: '{{asset('cart/images/img_2.png')}}'},
                {id: 3, name: 'product 3', summary: 'summary 3', price: 30, quantity: 1, image: '{{asset('cart/images/img_3.png')}}'}
            ],
        ...
        $("#addNewProduct").click(function(event) {
            ...
            $(".row").append('<div class="col-md-3 text-center"><img src="{{asset('cart/images/img_empty.png')}}" width="150px" height="150px"><br>product ' + currentElementNo + ' - <strong>$' + currentElementNo + '</strong><br><button class="btn btn-danger my-cart-btn" data-id="' + currentElementNo + '" data-name="product ' + currentElementNo + '" data-summary="summary ' + currentElementNo + '" data-price="' + currentElementNo + '" data-quantity="1" data-image="images/img_empty.png">Add to Cart</button><a href="#" class="btn btn-info">Details</a></div>')
        });
    });
</script>
